...
canais_extras = [
    ...
    {"id": "RadioSudoeste.pt", "nome": "Rádio Sudoeste - Direto", "logo": "https://raw.githubusercontent.com/thomraider12/icones_tv/main/radiosudoeste.png", "desc": "Um Festival de Rádio dedicated to festival MEO Sudoeste, promoted by Altice group and originally named Festival Sudoeste in portuguese southwest in the 1990 decade.\nActually is also on radio station with various frequences in Portugal."},
